    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center bg-black/40 backdrop-blur-sm transition-opacity animate-fade-in">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
          ...
          {word.roots && (
            <div className="mb-6">
              <h3 className="text-sm font-extrabold text-gray-400 uppercase tracking-widest mb-3 pl-2">词根词缀</h3>
          ...
          {examples.length > 0 && (
            <div className="mb-6">
              <h3 className="text-sm font-extrabold text-gray-400 uppercase tracking-widest mb-3 pl-2">例句</h3>
            ...
            <div className="flex gap-4">
              {synonyms.length > 0 && (
                <div className="flex-1 bg-green-50 p-4 rounded-2xl border-2 border-green-100">
                  <h4 className="text-xs font-black text-green-400 uppercase mb-2">同义词</h4>
              ...
              {antonyms.length > 0 && (
                <div className="flex-1 bg-red-50 p-4 rounded-2xl border-2 border-red-100">
                  <h4 className="text-xs font-black text-red-400 uppercase mb-2">反义词</h4>
                  <div className="flex flex-wrap gap-2">
                    {antonyms.map(a => (
