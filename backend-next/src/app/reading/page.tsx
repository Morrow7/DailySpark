...
export default function ReadingPage() {
  ...
  if (selectedArticle) {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-6 mb-24 animate-slide-up bg-[#FDFBF7]">
        {/* Header */}
  ...
  // List View
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 mb-24 md:mb-8 bg-[#FDFBF7]">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 bg-white px-4 py-1.5 rounded-full text-xs font-extrabold mb-4 shadow-sm text-orange-500 uppercase tracking-wider">
                  <Star size={12} fill="currentColor" /> 今日精选
                </div>
                ...
                <button className="cheese-btn-primary px-8 py-3.5 rounded-2xl text-base shadow-lg flex items-center gap-2 group-hover:gap-3 group-hover:scale-105 transition-all">
                  开始阅读 <BookOpen size={18} strokeWidth={3} />
                </button>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center justify-between mb-6 px-1">
            <h3 className="text-xl font-extrabold text-gray-800">所有文章</h3>
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className={`text-[10px] font-extrabold px-3 py-1 rounded-lg border ${article.level === 'Advanced' ? 'bg-red-50 text-red-500 border-red-100' :
          ...
          <div className="cheese-card p-6 sticky top-8 border-cheese-100 bg-white">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-3 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <div>
                  <div className="text-xs text-gray-400 font-bold uppercase tracking-wider">文章</div>
                  <div className="text-sm font-bold text-gray-700">已完成</div>
                </div>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <div>
                  <div className="text-xs text-gray-400 font-bold uppercase tracking-wider">分钟</div>
                  <div className="text-sm font-bold text-gray-700">阅读时长</div>
                </div>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-gray-100">
              <h4 className="font-bold text-xs text-gray-400 uppercase tracking-wider mb-3">每周目标</h4>
